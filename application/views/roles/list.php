<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i>Administración de Perfiles
        <small>Agregar / Editar Perfiles</small>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>roles/add"><i class="fa fa-plus"></i> Nuevo Perfil</a>
                </div>
            </div>
        </div>
        <div class="row">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'roles/edit/'.$record->roleId; ?>" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                            <a class="btn btn-sm btn-danger deleteRole" href="#" data-roleid="<?php echo $record->roleId; ?>" title="Borrar"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
