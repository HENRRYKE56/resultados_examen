<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Agregar / Editar Usuarios</small>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Ingresa la información del usuario</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <option value="">Seleccione una opción</option>
                                            ...
                                            <?php
                                             foreach ($grupo as $gpo)
                                             {?>
                                                <option value="<?php echo $gpo->cve_grupo ?>"><?php echo $gpo->des_grupo ?></option>
