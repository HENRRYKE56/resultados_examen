              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Ingresa datos del Usuario</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="isAdmin" name="isAdmin">
                                            ...
                                            <option value="<?= SYSTEM_ADMIN ?>" <?php if($isAdmin == SYSTEM_ADMIN) {echo "selected=selected";} ?>>Administrador del Sistema</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
