        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>addNew"><i class="fa fa-plus"></i> Nuevo usuario</a>
                </div>
            </div>
        </div>
        <div class="row">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'editOld/'.$record->userId; ?>" title="Edit"><i class="fas fa-pencil-alt"></i></a>
