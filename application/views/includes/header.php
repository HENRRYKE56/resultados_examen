...
<!-- Select2 -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/dist/plugins/select2/css/select2.min.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/dist/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
 
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/bower_components/summernote/summernote-bs4.min.css">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url(); ?>assets/dist/img/avatar.jpg" class="user-image" alt="Imagen del Usuario"/>
