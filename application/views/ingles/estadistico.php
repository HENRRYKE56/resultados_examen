            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" autocomplete="off" id="reporte" action="<?php echo base_url("reporte_estadistico") ?>" target="_blank" method="post" enctype="multipart/form-data" role="form">
                        <div class="box-body">
