              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Reporte por Estudiantes del Examen de Inglés 2025</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" autocomplete="off" id="reporte" action="<?php echo base_url("reporte_ingles") ?>" target="_blank" method="post" enctype="multipart/form-data" role="form">
                        <div class="box-body">
