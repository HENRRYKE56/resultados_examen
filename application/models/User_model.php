...
switch ($nombre) {
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.name,des_grupo, BaseTbl.mobile, BaseTbl.isAdmin, BaseTbl.createdDtm, Role.role');
        $this->db->from('tbl_users as BaseTbl');
        $this->db->join('tbl_roles as Role', 'Role.roleId = BaseTbl.roleId','left');
        $this->db->join('grupo_usuarios as grupo', 'grupo.cve_grupo = BaseTbl.isAdmin','left');
        if(!empty($searchText)) {
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.name,des_grupo, BaseTbl.mobile, BaseTbl.isAdmin, BaseTbl.createdDtm, 
